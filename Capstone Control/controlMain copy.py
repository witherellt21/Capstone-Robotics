...
class Simulation():
    ...
    def drawDivider(self):
            pygame.draw.rect(screen, (255,255,255), (screen.width*2/3, 0, screen.width/100, screen.height),0)

    def barrierExists(self, barrierList, x, y):
        for barrier in barrierList:
            if barrier.x == x and barrier.y == y:
                return True
        return False

    def displayText(self, text, font, x, y):
